    ...
    <div class="app-main" id="main">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('renew_update', [$media->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="bfg">
                                    ...
                                    <select name="fiscal_year" id="fiscal_year" class="form-control">
                                        ...
                                        <option value="{{$fiscal_year->fiscal_year}}" {{$renew->fiscal_year == $fiscal_year->fiscal_year ? 'selected' : ''}}>{{$fiscal_year->fiscal_year}}</option>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="remark" name="remark" class="form-control" value="{{$renew->remark}}">
