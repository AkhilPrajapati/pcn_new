    ...
    <div class="app-main" id="main">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('chairman_update', [$chairman->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    <label for="name">Chairman Name *</label>
                                    <input type="text" id="name" name="name" class="form-control" value="{{$chairman->name}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="nepali_name" name="nepali_name" class="form-control" value="{{$chairman->nepali_name}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="address" name="address" class="form-control" value="{{$chairman->address}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="date" id="appointment_date" name="appointment_date" class="form-control" value="{{$chairman->appointment_date}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="email" name="email" class="form-control" value="{{$chairman->email}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="contact" name="contact" class="form-control" value="{{$chairman->contact}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="citizen_number" name="citizen_number" class="form-control" value="{{$chairman->citizen_number}}">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="bfg">
                                    ...
                                    <input type="text" id="citizen_district" name="citizen_district" class="form-control" value="{{$chairman->citizen_district}}">
