        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3>
                        Add New Editor Details
                    </h3>
                </div>
                <div class="card-body">
                    <form action="{{route('editor_store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="see_marksheet" name="see_marksheet" class="form-control" value="{{old('see_marksheet')}}">
                            ...
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="see_character" name="see_character" class="form-control" value="{{old('see_character')}}">
                            ...
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="see_certificate" name="see_certificate" class="form-control" value="{{old('see_certificate')}}">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="slc_marksheet" name="slc_marksheet" class="form-control" value="{{old('slc_marksheet')}}">
                            ...
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="slc_character" name="slc_character" class="form-control" value="{{old('slc_character')}}">
                            ...
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="slc_certificate" name="slc_certificate" class="form-control" value="{{old('slc_certificate')}}">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="bachlor_marksheet" name="bachlor_marksheet" class="form-control" value="{{old('bachlor_marksheet')}}">
                            ...
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="bachlor_character" name="bachlor_character" class="form-control" value="{{old('bachlor_character')}}">
                            ...
                            <div class="col-md-4">
                                <div class="bfg">
                                    ...
                                    <input type="file" id="bachlor_certificate" name="bachlor_certificate" class="form-control" value="{{old('bachlor_certificate')}}">
