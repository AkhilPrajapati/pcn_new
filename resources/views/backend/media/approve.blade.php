    ...
    <div class="container">
        <div class="card">
            <div class="card-header my-3">
                <h4>Request under Approval</b></h4> 
            </div>
            <div class="card-body">
                ...
                <table class="table" border="1" style="background-color: ghostwhite">
                    ...
                    <tr>
                        <th>niyamawali</th>
                        <td>
                            <img src="{{(!empty($media->niyamawali))?url("/myuploads/media/$media->domain/$media->niyamawali"):url($image)}}" height="100" width="100">
                        </td>
                    ...
                    <form action="{{route('admin_media_approve_update', [$media->id])}}" method="POST">
                        @csrf
                        ...
                        <tr>
                            <td>
                                ...
                                <span>
                                    Give Proper Reasons Carefully
                                </span><br>
                                <span class="text-danger">@error('reason'){{$message}}@enderror</span>
                            </td>
                            <td>
                                <select name="reason[]" class="form-control select2" id="reason" multiple required>
                                    ...
                                    <option value="Editor Citizenship">Editor Citizenship</option>
                                    <option value="editor profile picture">editor profile picture</option>
                                    <option value="director address">director address</option>
                                    <option value="Company Registration Proof">Company Registration Proof</option>
                                    <option value="Domain Details">Domain Details</option>
                                    <option value="Add_Others">Add_Others</option>
                                </select>
                            </td>
                        </tr>
                    </form>
                    ...
                    <form action="{{route('admin_media_approve_update', [$media->id])}}" method="POST">
                        ...
                        <tr>
                            <td>
                                ...
                                <span>No reasons required</span>
                            </td>
                            <td>Congratulations, The Media is Approved</td>
                        </tr>
                    </form>
