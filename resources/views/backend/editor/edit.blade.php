    ...
    <div class="container" style="margin-top: -20px">
        <div class="card">
            <div class="card-header mt-3">
                <h3>Update Editor Details.</h3>
            </div>
            <div class="card-body">
                <form action="{{route('admin_editor_update', [$editor->id])}}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="bfg">
                                ...
                                <input type="date" name="appointment_date" class="form-control"  id="appointment_date"  value="{{$editor->appointment_date}}">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="bfg">
                                ...
                                <input type="date" name="retirement_date" class="form-control"  id="retirement_date"  value="{{$editor->retirement_date}}">
