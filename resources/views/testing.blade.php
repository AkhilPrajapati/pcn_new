      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="/myassets/backend/img/users/user-1.png" class="rounded-circle">
                    ...
                    <img alt="image" src="/myassets/backend/img/users/user-2.png" class="rounded-circle">
                    ...
                    <img alt="image" src="/myassets/backend/img/users/user-5.png" class="rounded-circle">
                  </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                      Ryan</span> <span class="time messege-text">Your payment invoice is
                      generated.</span> <span class="time">12 Min Ago</span>
                  </span>
                </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                    <img alt="image" src="/myassets/backend/img/users/user-4.png" class="rounded-circle">
                    ...
                    <img alt="image" src="/myassets/backend/img/users/user-3.png" class="rounded-circle">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="/myassets/backend/img/user.png"
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="/myassets/backend/img/logo.png" class="header-logo" /> <span
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img alt="image" src="/myassets/backend/img/users/user-5.png" width="35">
                            </td>
                            <td>2018-01-20</td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img alt="image" src="/myassets/backend/img/users/user-1.png" width="35">
                              <img alt="image" src="/myassets/backend/img/users/user-3.png" width="35">
                              <img alt="image" src="/myassets/backend/img/users/user-4.png" width="35">
                            </td>
                            <td>2018-04-10</td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <img alt="image" src="/myassets/backend/img/users/user-1.png" width="35">
                              <img alt="image" src="/myassets/backend/img/users/user-2.png" width="35">
                            </td>
                            <td>2018-01-29</td>
                            <td>
