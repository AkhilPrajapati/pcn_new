...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('editors', function (Blueprint $table) {
            ...
            $table->string('see_character')->nullable();
            $table->string('see_certificate')->nullable();

            $table->string('slc_marksheet')->nullable();
            $table->string('slc_character')->nullable();
            $table->string('slc_certificate')->nullable();

            $table->string('bachlor_marksheet')->nullable();
            $table->string('bachlor_character')->nullable();
            $table->string('bachlor_certificate')->nullable();
            $table->timestamps();
        });
    }
